...
# TESTER = 1
CSV_PATH = "C:/Users/nawaa/OneDrive/Desktop/Reading4All/ai/annotations/combinedData.csv"    # CHANGE THIS to your local path
local_root = "C:/Users/nawaa/Downloads/data/data"      # CHANGE THIS to your local path where your images are
IMAGE_ROOT = Path(local_root)

TRAIN_SPLIT = 0.8
RANDOM_SEED = 42

OUT_ROOT = Path("C:/Users/nawaa/OneDrive/Desktop/capstoneAI") / "trainSplit"   # CHANGE THIS to your local path where you 
...
def copyImages(split_df, target_dir):
    ...
    for _, row in split_df.iterrows():
        image_rel_path = str(row["Image-Path"]).lstrip("/")
        src_path = IMAGE_ROOT / image_rel_path
...
CSV_OUT_ROOT = Path("C:/Users/nawaa/OneDrive/Desktop/Reading4All/ai/train")    # CHANGE THIS to your local path 
