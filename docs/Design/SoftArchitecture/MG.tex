...
\begin{table}[h!]
  ...
  \begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
    ...
    {Main Screen Module (\refstepcounter{mnum} \mthemnum) (see \ref{mod: msm})} \\ &
    {Show History Screen Module (\refstepcounter{mnum} \mthemnum) (see \ref{mod: showhm})} \\ &
    {Log In Screen Module (\refstepcounter{mnum} \mthemnum) (see \ref{mod: lis})} \\ &
    {User Interface Accessibility Module (\refstepcounter{mnum} \mthemnum) (see \ref{mod: uia})} \\ 
    \midrule
...
\subsubsection{ShowHistoryScreen Module}
\label{mod: showhm}
\begin{description}
...
\subsubsection{UserInterfaceAccessibility Module}
\label{mod: uia}
\begin{description}
