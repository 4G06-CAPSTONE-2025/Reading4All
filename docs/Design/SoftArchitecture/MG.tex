...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.2\textwidth} p{0.6\textwidth}}
    ...
    FR5 &  \mref{mod:bcm_table}\\
    FR6 &  \mref{mod:bcm_table}\\
    \bottomrule
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.2\textwidth} p{0.6\textwidth}}
    ...
    PR-SR-HA1 & \mref{mod:bcm_table}\\
    PR-SR-HA2 &  \mref{mod:bcm_table}\\
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.2\textwidth} p{0.6\textwidth}}
    ...
    \textbf{Req.} & \textbf{Modules}\\
    \midrule
    SR-AR1 & \mref{mod:bcm_table}\\
    SR-AR2 & \mref{mod:bcm_table}\\
