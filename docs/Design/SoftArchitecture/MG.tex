...
\begin{itemize}
  \item Hardware-Hiding Module \label{mHH}
  \item Behaviour-Hiding Module \label{mBH}
  \item Software Decision Module \label{mSD}
\end{itemize}
...
\begin{table}[h!]
  ...
  \begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
    ...
    \multirow{4}{0.3\textwidth}{Software Decision Module [Section
    (\ref{mod:sdmmain})]} &
    {AIModelTraining Module (see \ref{mod:modeltraining})}\\ &
