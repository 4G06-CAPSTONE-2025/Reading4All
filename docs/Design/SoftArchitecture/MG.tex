...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.2\textwidth} p{0.6\textwidth}}
    ...
    \midrule
    FR1 & \mref{mod:preprocessing_table}, \mref{mod:imgvalidmod_table}, \mref{mod:bcm_table}\\
    FR2 & \mref{mod:captiongeneration_table}, \mref{mod:bcm_table}\\
    FR3 & \mref{}\\
    FR4 & \mref{mod:bcm_table}\\
    FR5 &  \mref{mod:bcm_table}, \mref{mod:mess}\\
    FR6 &  \mref{mod:bcm_table},\mref{mod:auth_table}\\
    \bottomrule
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.2\textwidth} p{0.6\textwidth}}
    ...
    PR-SR-HA1 & \mref{mod:bcm_table}, \mref{mod:logmod_table},  \mref{mod:mess}, \mref{mod:auth_table}\\
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.2\textwidth} p{0.6\textwidth}}
    ...
    SR-AR2 & \mref{mod:bcm_table}, \mref{mod:mess}\\
