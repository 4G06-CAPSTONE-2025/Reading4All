...
WCAG-compliant contrast ratios, non-color-dependent cues, and fully descriptive alt text for non-text elements. These display modules present 
...
Table ~\ref{TblUPRT}, Table ~\ref{TblART}, Table ~\ref{TblPRT}, Table ~\ref{TblOERT}, Table ~\ref{TblMSRT}, Table ~\ref{TblSRT1},
 Table ~\ref{TblCR}, Table ~\ref{TbltCompR}. It's important to note some requirements do not map to a module because they describe coding practices or infrastructure details. 
