...
~\ref{TblLFRT}, Table ~\ref{TblLFRT}, Table ~\ref{TblSRT}, Table ~\ref{TblURT}, Table ~\ref{TblPIRT}, Table ~\ref{TblLRMT}, 
Table ~\ref{TblUPRT}, Table ~\ref{TblART},  Table ~\ref{TblPRT},  Table ~\ref{TblOERT},  Table ~\ref{TblMSRT}, Table ~\ref{TblSRT1},
Table ~\ref{TblCR}, Table ~\ref{TbltCompR}, Table ~\ref{TbltCompR}. It's important to note some requirements do not map to a module because they describe coding practices or infrastructure details. 
