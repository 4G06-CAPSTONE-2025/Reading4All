...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
uploadImage & imageFilePath:String & Success:\Bool & FileNotFound \\
downloadText & altText:String & altTextFile:String (.txt) & NetworkError \\
...
\section{MIS of Authentication Module}\label{authentication} \wss{Use labels for
cross-referencing}
