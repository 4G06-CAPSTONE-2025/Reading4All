...
Assumes input images are valid and accessible through the system interface.
...
\subsubsection{Environment Variables}
Active connection to the user interface or backend responsible for displaying generated captions.
...
\subsubsection{Local Functions}
splitData(): Divides input data into training and validation portions.
...
\begin{center}
  \begin{tabular}{|l|l|l|l|}
    ...
    \textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
    \hline
    evaluateCaption & CaptionText & PerformanceScores & EvaluationException \\
    \hline
  \end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}{|l|l|l|l|}
    ...
    \textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
    \hline
    updateModel & PerformanceScores & UpdateAck & UpdateException \\
    \hline
  \end{tabular}
\end{center}
...
\section{MIS of BackendController Module} \label{Module} \wss{Use labels for
cross-referencing}
