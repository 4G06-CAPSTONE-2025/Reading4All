...
\texttt{Filesystem}: used to read image files from the paths.\\
...
\begin{itemize}
  ...
  \end{itemize}
  \item \textbf{output:} Returns the preprocessed and encoded representation of the input examples.
  \item \textbf{exception:} Raises an \texttt{InvalidInputException} exception if the input examples are missing required fields, contain unreadable image data, or cannot be processed successfully.
\end{itemize}
