...
\hline
validateImage & image, userToken: & imageStatus:\Bool & InvalidImageException\\
\hline
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
validateImageFile & image, userToken:String & imageStatus: \(\mathbb{B}\)& InvalidImageType-Exception \\
\hline
\end{tabular}
\end{center}
