...
April 4, 2026 & 1.2 & Added explicit table references, corrected table numbering, and updated formatting to ensure all tables are properly labeled and referenced. \\
April 6, 2026 & 1.3 & Converted large tables to longtable to prevent footer overlap; added introductory text to Sections 4 and 5; replaced bitmap figures where needed. \\
\bottomrule
\end{tabularx}
