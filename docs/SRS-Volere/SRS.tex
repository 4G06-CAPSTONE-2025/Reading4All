...
\item \emph{The codebase shall be maintainable and adaptable to updates in WCAG guidelines, software libraries, and ML frameworks.}\\[2mm] 
    ...
    {\bf Priority:} Medium
    \item\emph{The prototype shall maintain compatibility with at least the next two Python releases.}\\
...
\begin{enumerate}
    \item Before using the interface effectively, staff or instructors may need some orientation or brief training because they may initially find it unfamiliar.
    \item Users could depend only on the automated descriptions without checking to see if they are accurate or compliant with accessibility standards.
\end{enumerate}

\subsection{Limitations in the Anticipated Implementation Environment That May Inhibit the New Product}

\begin{enumerate}
    \item Reading4All may not be able to fully integrate with all platforms used for course delivery due to certain institutional systems or access controls.
    \item Depending on the system resources available, performance may differ between devices or software environments.
    \item The way generated descriptions are communicated to end users may be impacted by variations in screen readers or accessibility tools.
\end{enumerate}
