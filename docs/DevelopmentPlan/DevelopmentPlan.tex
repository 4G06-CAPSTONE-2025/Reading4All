...
October 2, 2025, Casey Francine Bulaclac, Address Peer Feedback \texttt{\#31}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Test coverage must meet the following tiered standards:
    \begin{itemize}
        \item $\geq$ 90\% for core logic (model processing, backend functions)
        \item $\geq$ 70\% for UI functionality
        \item Overall project coverage target: 80--85\%
    \end{itemize}
...
Low productivity includes missing team deadlines without giving teammates advance notice, failing to provide consistent updates or proactively look for ways to contribute,
and not responding to messages within 24 hours (or within 48 hours in emergencies).
