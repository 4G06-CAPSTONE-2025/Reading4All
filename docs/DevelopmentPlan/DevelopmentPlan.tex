...
This document outlines the development plan for Team 22's Capstone Project ``Reading4All''. 
First, it highlights the confidential information, intellectual property to protect, and copyright 
license. It also details information about the team such as team meeting plans, communication,
...
\begin{itemize}
  ...
  Milestones will be used to represent our deliverables. Each milestone will group the related issue that compose the deliverable and as issues are closed, we can track our progress and the additional effort needed to submit the deliverable.
