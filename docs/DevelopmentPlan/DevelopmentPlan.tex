...
\begin{enumerate}
    ...
    \begin{itemize}
        \item These requirements will be based on AODA and Web Content Accessibility Guidelines (WCAG) 2.1, focusing on clarity, conciseness, and compatibility with screen readers. For the proof of concept, the team will try to incoporate as many requirements possible.
    \end{itemize}
    ...
    \item Demonstrate proof of integration with tab based navigation on user interface.
    \begin{itemize}
        \item Final validation will involve testing with tab based keyboard navigation to ensure all user interface components can be navigated and function properly
    \end{itemize}
\end{enumerate}
