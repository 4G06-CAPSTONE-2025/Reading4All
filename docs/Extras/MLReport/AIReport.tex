...
\begin{itemize}
    ...
    \item \textbf{Fiza Sehar:} BLIP research, Training Revision 0 and Revision 1 models, Dataset preprocessing, Alt text annotation and refinement, CLIP-based category routing, Prompt conditioning, User testing analysis    \item \textbf{Dhruv Sardana:}
