...
def test_validate_image_routing():
    ...
    controller.image_validator.validate_image = MagicMock(return_value=valid_img_return_value)
...
def test_gen_alt_text_routing():
    ...
    controller.gen_alt_text_for_img.trigger_model = MagicMock(return_value=gen_alt_text_return)
...
def test_get_alt_text_history_routing():
    ...
    controller.history_info.get_alt_text_history = MagicMock(return_value=get_alt_history_return)
...
def test_edit_alt_text_routing():
    ...
    controller.edit_alt_text_service = MagicMock(return_value=edit_alt_text_return)
